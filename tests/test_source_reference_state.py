...
from translationzed_py.gui.source_reference_state import (
    ...
    apply_source_reference_pin_toggle,
...
def test_apply_source_reference_mode_change_updates_file_override() -> None:
    ...
    assert "SOURCE_REFERENCE_FILE_OVERRIDES" in extras


def test_apply_source_reference_pin_toggle_round_trip() -> None:
    extras: dict[str, str] = {}
    overrides: dict[str, str] = {}
    root = Path("/tmp/proj")
...
def test_apply_source_reference_preferences_updates_policy_and_clears_overrides() -> (
    None
):
    extras: dict[str, str] = {}
    ...
    policy, changed = apply_source_reference_preferences(
        values={
            ...
            "source_reference_clear_overrides": True,
        },
