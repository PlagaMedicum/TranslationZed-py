...
# Phase-1 ratchet defaults (A31): 91/96.
# Phase-2 promotion target (not default yet): 92/97 after evidence window closure.
OVERALL_FAIL_UNDER="${COVERAGE_FAIL_UNDER_OVERALL:-91}"
CORE_FAIL_UNDER="${COVERAGE_FAIL_UNDER_CORE:-96}"
