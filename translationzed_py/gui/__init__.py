...
from translationzed_py.core.runtime_diagnostics import configure_logging

from .app import get_app
from .main_window import MainWindow
from .runtime_reliability import gui_exception_boundary


def launch(project_root: str | None = None) -> None:
    """Create and run the main window for an optional project root."""
    with gui_exception_boundary(log_path=configure_logging()) as boundary:
        app = get_app()
        win = MainWindow(project_root)
        boundary.set_parent(win)
