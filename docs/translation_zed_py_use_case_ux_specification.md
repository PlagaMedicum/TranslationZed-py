...
| **Flow** |
|  1 | SYS opens TM file picker (`.tmx`, `.xliff`, `.xlf`, `.po`, `.pot`). |
...
| **Trigger** | User drops supported TM files (`.tmx`, `.xliff`, `.xlf`, `.po`, `.pot`) into the managed TM import folder outside the app. |
| **Flow** |
