...
| `description.txt` | Existing generic single-row table/detail editing is accepted as complete. No separate editor or workflow; only optional file-tree presentation polish remains. |
